...
Last step, you just need to edit the custom miner section with the address of the astrix node you're mining to. This needs the full ip/port so it'll look similar to `192.168.0.12:42110` save the changes after you're finished
...
Ideally you'd run the bridge on the same machine that your astrixd node is running on. You can follow any of the installation methods defined in the main readme of the repo.
