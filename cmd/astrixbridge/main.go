...
import (
	...
	"path"
	"time"
	"github.com/nickygreen/test2/cmd/astrixbridge"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	cfg := astrixstratum.BridgeConfig{}
	...
	log.Printf("\astrixd:       	 %s", cfg.RPCServer)
	...
	if err := astrixstratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
